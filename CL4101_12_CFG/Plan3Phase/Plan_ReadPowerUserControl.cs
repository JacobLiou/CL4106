...
{
    public partial class Plan_ReadPowerUserControl : UserControl
    {
        private string XmlFilePath = Application.StartupPath + pwFunction.pwConst.Variable.CONST_WORKPLANPATH;
        private string _NodeName = "Plan_ReadPower";
        private string _NodeDescription = "读整机功耗";
        private bool m_Checked = false;//是否要检
        private string m_Para = "";//项目参数

        public Plan_ReadPowerUserControl()
        {
            InitializeComponent();
            Init();
        ...
        public void Load()
        {
            try
            {
                ...
                txt_MinP.Text = _Pata[0];
                txt_MaxP.Text = _Pata[1];
                txt_MinP2.Text = _Pata[2];
                txt_MaxP2.Text = _Pata[3];
            }
            catch
            {
        ...
        {
            m_Para = txt_MinP.Text + "|";
            m_Para += txt_MaxP.Text + "|";
            m_Para += txt_MinP2.Text + "|";
            m_Para += txt_MaxP2.Text + "|";
