...
{
    public partial class Plan_Comm2TestUserControl : UserControl
    {
        private string XmlFilePath = Application.StartupPath + pwFunction.pwConst.Variable.CONST_WORKPLANPATH;
        private string _NodeName = "Plan_Comm2Test";
        private string _NodeDescription = "第2路通讯口测试";
        private bool m_Checked = false;//是否要检
        private string m_Para = "";//项目参数

        public Plan_Comm2TestUserControl()
        {
            InitializeComponent();
            Init();
        ...
        private void SaveCurrentData(ref XmlNode xml)
        {
            ...
            xml.AppendChild(clsXmlControl.CreateXmlNode(_NodeName
                    , "ID", "ProductsName"
                    , "Name", "项目参数"
                    , "Value", m_Para));//协议|标识编码|长度|小数点|下发参数 "DLT645_2007|00010000|4|2||1|5"
