    ...
    public partial class Plan_SetWdUserControl : UserControl
    {
        ...
        private void CreateDefaultData(ref XmlNode xml)
        {
            ...
            xml.AppendChild(clsXmlControl.CreateXmlNode(_NodeName
                    , "ID", "ProductsName"
                    , "Name", "项目参数"
                    , "Value", "DLT645_2007|04CC800F|1|0|26|"));//协议|标识编码|长度|参数
