...
{
    public partial class Plan_ReadEnergyUserControl : UserControl
    {
        ...
        public Plan_ReadEnergyUserControl()
        {
            InitializeComponent();
            Init();
        ...
        public void Load()
        {
            ...
            txtPowerUP.Text = _Pata[5];//上限值
            txtPowerDown.Text = _Pata[6];//下限值
        }
        ...
        private void CreateDefaultData(ref XmlNode xml)
        {
            ...
            xml.AppendChild(clsXmlControl.CreateXmlNode(_NodeName
                    , "ID", "ProductsName"
                    , "Name", "项目参数"
                    , "Value", "DLT645_1997|00000000|4|2||50|0.2|"));//协议|标识编码|长度|小数点|下发参数|上限值|下限值
        ...
        private void SaveCurrentData(ref XmlNode xml)
        {
            ...
            m_Para += txtPowerUP.Text + "|";
            m_Para += txtPowerDown.Text + "|";
            #region -----------读电能量-----------
            xml.AppendChild(clsXmlControl.CreateXmlNode(_NodeName
                    , "ID", "IsCheck"
                    , "Name", "是否要检"
            ...
            xml.AppendChild(clsXmlControl.CreateXmlNode(_NodeName
                    , "ID", "ProductsName"
                    , "Name", "项目参数"
                    , "Value", m_Para));//协议|标识编码|长度|小数点|下发参数"DLT645_1997|00000000|4|2||50|0.2"
