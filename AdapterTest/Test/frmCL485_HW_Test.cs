...
{
    public partial class frmCL485_HW_Test : Form
    {
        ...
        private string m_BTL = "1200,E,8,1";
        public frmCL485_HW_Test()
        {
            InitializeComponent();
        }
        ...
        {
            m_BTL=comboBox3.SelectedText+ ",E,8,1";
        }
    }
}
